...
const Login = () => {
  ...
  useEffect(() => {
    ...
    if (accs.length > 0) {
      ...
      setRememberMe(true); // Default to true if they have saved accounts
    }
  }, [navigate]);
            ...
            >
              ...
              <div className="flex-1 flex flex-col justify-center px-10 sm:px-14 py-8 relative z-10">
                ...
                <div className="w-full">
                  <AnimatePresence mode="wait">
                    {error && (
                      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="p-4 rounded-xl bg-red-50 border border-red-100 text-red-600 text-[11px] font-black uppercase tracking-wider flex items-center gap-3 shadow-sm mb-6">
                        ...
                        {selectedAccount ? (
                          ...
                          <div className="group">
                            <div className="flex items-center justify-between px-1 mb-2">
                              <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 group-focus-within:text-(--theme-500) transition-colors">Usuario</label>
                              {savedAccounts.length > 0 && (
                                <button type="button" onClick={() => setShowAccountsList(true)} className="text-[10px] font-bold text-slate-400 hover:text-(--theme-500) transition-colors bg-slate-50 px-2 py-1 rounded-md">
