...
const CloserCalendario = () => {
    ...
    useEffect(() => {
        ...
        // 1. Sabemos que no está vinculado (googleLinked === false)
        // 2. No lo hemos omitido ya
        if (!isDismissed && googleLinked === false) {
                ...
                <div className="absolute inset-0 z-100 bg-gray-900/40 backdrop-blur-sm flex items-center justify-center p-4">
                    <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full text-center border border-gray-100 animate-in zoom-in-95 duration-300">
                        ...
                        <p className="text-gray-600 mb-8 leading-relaxed">
                            Para mejor funcionalidad vincula tu cuenta a Google en <span className="font-bold text-(--theme-600)">Ajustes &gt; Google</span>. Podrás ver tus reuniones agendadas y crear salas de Meet automáticamente.
                        </p>
