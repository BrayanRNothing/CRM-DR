...
import logoUPDM from '../assets/logodr.png';
    ...
    return (
        <AnimatedGridBackground mode="light">
            <div className="h-screen flex p-4 gap-4">
                ...
                <FloatingSidebar
                    menuItems={menuItems}
                    userInfo={{ ...usuario, rol: usuario?.rol === 'doctor' ? 'Doctor' : 'Closer' }}
                    title="CRM DR"
                    subtitle={usuario?.rol === 'doctor' ? 'Medical System' : 'Closing Manager'}
                    logo={logoUPDM}
