...
import defaultLogo from '../assets/medicrmlogo.png';
...
const AppLayout = () => {
    ...
    // Aquí podríamos tener un contexto o estado global para la configuración de la empresa
    // Por ahora, leemos el logo por defecto o uno que venga en el usuario si existiera.
    ...
    return (
        <AnimatedGridBackground mode="light">
            <div className="h-screen flex p-4 gap-4">
                {/* Floating Sidebar adaptativo */}
                <FloatingSidebar
                    menuItems={menuItems}
                    userInfo={{ ...usuario, rol: usuario.rol === 'admin' ? 'Administrador' : usuario.rol.charAt(0).toUpperCase() + usuario.rol.slice(1) }}
                    title={nombreEmpresa}
                    subtitle={usuario.modo_crm === 'cooperativo' ? "Espacio Cooperativo" : "Espacio Individual"}
                    logo={logoEmpresa}
