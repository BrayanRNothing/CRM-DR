            ...
            <div className="max-w-7xl mx-auto space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <div className="flex justify-between mb-2">
                                    ...
                                    <span className="text-blue-700 font-semibold">{stats.metricas.mes.exitosas}</span>
                                </div>
                                <div className="h-3 bg-gray-700 rounded-full overflow-hidden">
                                    <div
                                        className="h-full bg-gradient-to-r from-blue-800 to-blue-700 rounded-full"
                                        style={{ width: `${stats.metricas.mes.tasaContacto}%` }}
                                    />
                                </div>
                            </div>
                            <div className="pt-4 border-t border-gray-700">
                                <p className="text-center text-5xl font-bold text-blue-700 mb-1">{stats.metricas.mes.tasaContacto}%</p>
                ...
                <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div className="text-center p-6 bg-blue-800/10 rounded-lg border border-blue-800/30">
                            <p className="text-5xl font-bold text-blue-700 mb-2">{stats.distribucion.en_contacto}</p>
                            <p className="text-gray-400 text-sm">En Contacto</p>
                            <p className="text-blue-500 text-xs mt-2">{stats.resumen.totalClientes > 0 ? ((stats.distribucion.en_contacto / stats.resumen.totalClientes) * 100).toFixed(1) : 0}%</p>
                        </div>
                            ...
                            <tbody>
                                {stats.rendimientoSemanal.map((semana, index) => (
                                    <tr key={index} className="border-b border-gray-800 hover:bg-gray-700/30 transition-colors">
                                        ...
                                        <td className="p-4 text-center text-blue-700 font-semibold text-sm">{semana.contactos}</td>
