    ...
    return (
        <div className="h-full flex flex-col p-4 sm:p-6 overflow-y-auto bg-slate-50/50">
            ...
            <div className="mb-4">
                ...
                <p className="text-slate-500 text-sm font-medium mt-1">Análisis profundo del ciclo de vida de tus contactos.</p>
            </div>
                ...
                <FunnelVisual
                    stages={[
                        ...
                        },
                        {
                            ...
                            cantidadPerdida: cData.analisisPerdidas?.no_asistio || 0,
