...
export const HistorialInteracciones = ({ timeline = [], esProspector = true, onDeleteActividad }) => {
    ...
    const getRolBadge = (item) => {
        ...
        return esProspectorActividad ? (
            ...
            <span className="text-xs bg-blue-100 text-blue-950 px-2 py-0.5 rounded-full font-semibold">🏁 Closer</span>
        );
    };
            ...
            <div className="pt-4 border-t border-slate-200">
                <div className="grid grid-cols-4 gap-3 text-sm">
                    ...
                    <div className="bg-blue-50 border border-blue-300 rounded-lg p-3 text-center">
                        <p className="text-xs text-blue-900 font-semibold mb-1">Del Closer</p>
